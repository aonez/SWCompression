...
extension TarReaderTests {
    // DO NOT MODIFY: This is autogenerated, use:
    //   `swift test --generate-linuxmain`
    // to regenerate.
    static let __allTests__TarReaderTests = [
        ("test", test),
    ]
}
...
extension TarWriterTests {
    // DO NOT MODIFY: This is autogenerated, use:
    //   `swift test --generate-linuxmain`
    // to regenerate.
    static let __allTests__TarWriterTests = [
        ("test", test),
    ]
}
...
public func __allTests() -> [XCTestCaseEntry] {
    return [
        ...
        testCase(TarReaderTests.__allTests__TarReaderTests),
        testCase(TarTests.__allTests__TarTests),
        testCase(TarWriterTests.__allTests__TarWriterTests),
